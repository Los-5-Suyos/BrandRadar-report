...
|---------|--------|-------------|------------------------|
| EP01 | Gestión de Cuentas | Agrupa registro, verificación de correo e inicio/cierre de sesión para PyME Owner y Agency Manager. | US01, US02, US03, US04 |
| EP02 | Configuración de Marca | Creación y configuración de marcas/clientes con palabras clave y fuentes de datos conectadas. | US05, US06, US07, US08 |
| EP03 | Monitoreo de Menciones | Inicio del monitoreo, recolección y filtrado de menciones desde plataformas digitales. | US09, US10, US11 |
| EP04 | Análisis de Sentimiento | Clasificación automática del sentimiento de las menciones y visualización de tendencias. | US12, US13, US14 |
| EP05 | Gestión de Alertas | Generación de alertas automáticas ante menciones críticas, notificación y flujo de respuesta. | US15, US16, US17 |
| EP06 | Reportes y Dashboard | Visualización del dashboard, generación, comparación y exportación de reportes de reputación. | US18, US19, US20, US21 |
| EP07 | Landing Page | Sitio web estático informativo dirigido a visitantes PyME y de agencia digital. | US22, US23, US24, US25, US26 |
| EP08 | Implementación Técnica y APIs | Endpoints de autenticación, marcas, menciones, sentimiento, alertas y reportes para garantizar que las funcionalidades estén disponibles de forma segura. | TS01, TS02, TS03, TS04, TS05, TS06, TS07, TS08, TS09, TS10, TS11 |
...
|-----------------|--------|-------------|-------------------------|---------------------------|
| EP01 | Gestión de Cuentas | Agrupa registro, verificación de correo e inicio/cierre de sesión para PyME Owner y Agency Manager. | — | — |
| US01 | Registrar cuenta | Como PyME Owner o Agency Manager, quiero crear una cuenta con mis datos básicos para acceder a las funcionalidades de monitoreo de reputación. | **Escenario 1 – Registro exitoso:** <br> **Given** el usuario completa todos los campos obligatorios (nombre, correo, contraseña y tipo de cuenta) <br> **When** envía el formulario <br> **Then** el sistema crea la cuenta, envía correo de verificación y muestra "Cuenta creada. Revisa tu correo para verificarla." <br><br> **Escenario 2 – Correo ya registrado:** <br> **Given** el usuario ingresa un correo ya existente en el sistema <br> **When** envía el formulario <br> **Then** el sistema muestra "El correo ya está registrado" y no crea duplicado. <br><br> **Escenario 3 – Contraseña débil:** <br> **Given** la contraseña no cumple los requisitos (8 caracteres, 1 mayúscula, 1 número) <br> **When** envía el formulario <br> **Then** el sistema resalta los requisitos incumplidos y no permite continuar. | EP01 |
| US02 | Verificar correo electrónico | Como usuario recién registrado, quiero verificar mi correo para activar mi cuenta y acceder a BrandRadar. | **Escenario 1 – Verificación exitosa:** <br> **Given** el usuario hace clic en el enlace dentro de las 24 horas <br> **When** el sistema valida el token <br> **Then** la cuenta se activa y redirige al login con "Correo verificado exitosamente." <br><br> **Escenario 2 – Token expirado:** <br> **Given** el usuario hace clic después de 24 horas <br> **When** el sistema intenta validar el token <br> **Then** muestra "El enlace ha expirado" y ofrece reenviar el correo. <br><br> **Escenario 3 – Token inválido:** <br> **Given** el usuario accede con un token manipulado o incorrecto <br> **When** el sistema lo valida <br> **Then** muestra "Enlace de verificación inválido" y no activa la cuenta. | EP01 |
| US03 | Iniciar sesión | Como PyME Owner o Agency Manager con cuenta verificada, quiero iniciar sesión para acceder a mi panel de monitoreo. | **Escenario 1 – Login exitoso:** <br> **Given** credenciales válidas y cuenta verificada <br> **When** envía el formulario <br> **Then** el sistema genera token JWT y redirige al dashboard. <br><br> **Escenario 2 – Credenciales incorrectas:** <br> **Given** el usuario ingresa contraseña incorrecta <br> **When** envía el formulario <br> **Then** muestra "Correo o contraseña incorrectos" y no otorga acceso. <br><br> **Escenario 3 – Cuenta no verificada:** <br> **Given** la cuenta aún no tiene el correo verificado <br> **When** envía el formulario <br> **Then** muestra "Debes verificar tu correo antes de iniciar sesión" y ofrece reenvío. | EP01 |
| US04 | Cerrar sesión | Como usuario autenticado, quiero cerrar sesión para proteger el acceso desde dispositivos compartidos. | **Escenario 1 – Cierre exitoso:** <br> **Given** el usuario autenticado hace clic en "Cerrar sesión" <br> **When** el sistema procesa la solicitud <br> **Then** la sesión se invalida y redirige al login. <br><br> **Escenario 2 – Sesión expirada:** <br> **Given** el token de sesión ya expiró <br> **When** el usuario accede a una ruta protegida <br> **Then** el sistema redirige automáticamente al login. <br><br> **Escenario 3 – Cierre desde múltiples pestañas:** <br> **Given** el usuario cierra sesión en una pestaña <br> **When** navega en otra pestaña <br> **Then** el sistema detecta la sesión inválida y redirige al login. | EP01 |
| EP02 | Configuración de Marca | Creación y configuración de marcas/clientes con palabras clave y fuentes de datos conectadas. | — | — |
| US05 | Crear perfil de marca (PyME) | Como PyME Owner, quiero crear el perfil de mi marca con información básica y palabras clave para que BrandRadar comience a monitorizarla. | **Escenario 1 – Creación exitosa:** <br> **Given** nombre, descripción y al menos una palabra clave completados <br> **When** guarda la configuración <br> **Then** el sistema registra la marca y confirma "Marca creada exitosamente." <br><br> **Escenario 2 – Nombre duplicado:** <br> **Given** el nombre de marca ya existe en la cuenta <br> **When** intenta guardar <br> **Then** muestra "Ya tienes una marca con ese nombre" y no crea duplicado. <br><br> **Escenario 3 – Sin palabras clave:** <br> **Given** no se ingresó ninguna palabra clave <br> **When** intenta guardar <br> **Then** muestra "Debes agregar al menos una palabra clave" y no permite continuar. | EP02 |
| US06 | Agregar marca de cliente (Agency) | Como Agency Manager, quiero agregar una nueva marca de cliente para comenzar a gestionar su reputación digital. | **Escenario 1 – Alta exitosa:** <br> **Given** nombre, sector y al menos una palabra clave completados <br> **When** guarda el perfil <br> **Then** el sistema registra la marca y la asocia a la cuenta de agencia. <br><br> **Escenario 2 – Límite de marcas alcanzado:** <br> **Given** el plan no permite más marcas <br> **When** intenta agregar una nueva <br> **Then** muestra "Has alcanzado el límite de marcas de tu plan" y ofrece actualizar. <br><br> **Escenario 3 – Datos incompletos:** <br> **Given** el nombre del cliente está vacío <br> **When** intenta guardar <br> **Then** resalta los campos obligatorios vacíos y no registra la marca. | EP02 |
| US07 | Configurar palabras clave | Como PyME Owner o Agency Manager, quiero configurar y editar palabras clave de una marca para que el monitoreo capture menciones relevantes. | **Escenario 1 – Edición exitosa:** <br> **Given** el usuario modifica o agrega términos en la configuración <br> **When** guarda los cambios <br> **Then** el sistema actualiza las palabras clave y confirma "Palabras clave actualizadas." <br><br> **Escenario 2 – Palabra clave duplicada:** <br> **Given** la palabra clave ya existe para esa marca <br> **When** confirma la adición <br> **Then** muestra "Esta palabra clave ya fue agregada" y no genera duplicado. <br><br> **Escenario 3 – Límite de plan alcanzado:** <br> **Given** se alcanzó el límite permitido por el plan <br> **When** intenta agregar una más <br> **Then** muestra "Has alcanzado el límite de palabras clave para este plan." | EP02 |
| US08 | Conectar fuentes de datos | Como PyME Owner o Agency Manager, quiero conectar plataformas digitales a una marca para que BrandRadar recolecte menciones de esas fuentes. | **Escenario 1 – Conexión exitosa:** <br> **Given** plataforma seleccionada y credenciales válidas <br> **When** confirma la integración <br> **Then** el sistema muestra estado "Conectado" e incluye la fuente en el monitoreo activo. <br><br> **Escenario 2 – Credenciales inválidas:** <br> **Given** el usuario ingresa credenciales incorrectas <br> **When** el sistema intenta validar la conexión <br> **Then** muestra "No se pudo conectar. Verifica tus credenciales." <br><br> **Escenario 3 – Plataforma no disponible:** <br> **Given** el servicio externo está temporalmente inactivo <br> **When** intenta establecer la conexión <br> **Then** muestra "La plataforma no está disponible. Intenta más tarde." | EP02 |
| EP03 | Monitoreo de Menciones | Inicio del monitoreo, recolección y filtrado de menciones desde plataformas digitales. | — | — |
| US09 | Iniciar monitoreo de marca | Como PyME Owner o Agency Manager, quiero iniciar el monitoreo de una marca configurada para que BrandRadar recolecte menciones en tiempo real. | **Escenario 1 – Inicio exitoso:** <br> **Given** al menos una palabra clave y una fuente conectada <br> **When** el usuario activa el monitoreo <br> **Then** el estado cambia a "Monitoreando" y se registra la fecha y hora de inicio. <br><br> **Escenario 2 – Configuración incompleta:** <br> **Given** la marca no tiene fuentes de datos conectadas <br> **When** intenta iniciar el monitoreo <br> **Then** muestra "Conecta al menos una fuente antes de iniciar el monitoreo." <br><br> **Escenario 3 – Monitoreo ya activo:** <br> **Given** el monitoreo ya está en ejecución <br> **When** intenta iniciarlo de nuevo <br> **Then** muestra "El monitoreo de esta marca ya está activo." | EP03 |
| US10 | Visualizar menciones recolectadas | Como PyME Owner o Agency Manager, quiero ver el listado de menciones recolectadas para estar al tanto de lo que se dice sobre mi marca. | **Escenario 1 – Listado con menciones:** <br> **Given** el sistema ha recolectado menciones para la marca seleccionada <br> **When** accede a la sección de menciones <br> **Then** muestra fuente, fecha, texto y sentimiento de cada mención. <br><br> **Escenario 2 – Sin menciones aún:** <br> **Given** el monitoreo está activo pero sin menciones recolectadas <br> **When** accede a la sección <br> **Then** muestra "No se han encontrado menciones aún. El monitoreo está en proceso." <br><br> **Escenario 3 – Error de fuente:** <br> **Given** una fuente presenta falla de conexión durante el monitoreo <br> **When** accede al listado <br> **Then** muestra aviso de la fuente con error y continúa mostrando las demás. | EP03 |
| US11 | Filtrar menciones por criterio | Como PyME Owner o Agency Manager, quiero filtrar menciones por fecha, fuente o sentimiento para encontrar rápidamente las más relevantes. | **Escenario 1 – Filtro con resultados:** <br> **Given** el usuario aplica uno o más filtros (fecha, fuente, sentimiento) <br> **When** confirma el filtro <br> **Then** muestra solo menciones que cumplen los criterios seleccionados. <br><br> **Escenario 2 – Sin resultados:** <br> **Given** los filtros no coinciden con ninguna mención <br> **When** confirma el filtro <br> **Then** muestra "No hay menciones que coincidan con los filtros aplicados." <br><br> **Escenario 3 – Resetear filtros:** <br> **Given** hay filtros activos aplicados al listado <br> **When** hace clic en "Limpiar filtros" <br> **Then** elimina todos los filtros y muestra el listado completo. | EP03 |
| EP04 | Análisis de Sentimiento | Clasificación automática del sentimiento de las menciones y visualización de tendencias. | — | — |
| US12 | Ver análisis de sentimiento general | Como PyME Owner o Agency Manager, quiero ver el análisis de sentimiento general de mi marca para entender cómo está siendo percibida en internet. | **Escenario 1 – Análisis disponible:** <br> **Given** la marca tiene menciones clasificadas por sentimiento <br> **When** accede a la sección de análisis <br> **Then** muestra distribución porcentual positivo/negativo/neutro con gráfico resumen. <br><br> **Escenario 2 – Análisis en proceso:** <br> **Given** el sistema aún está clasificando menciones recientes <br> **When** accede a la sección <br> **Then** muestra estado "Análisis en proceso" junto con los datos ya disponibles. <br><br> **Escenario 3 – Sin datos suficientes:** <br> **Given** la marca tiene menos de 5 menciones recolectadas <br> **When** accede a la sección <br> **Then** muestra "Datos insuficientes. El análisis estará disponible con más menciones." | EP04 |
| US13 | Ver menciones por sentimiento | Como PyME Owner o Agency Manager, quiero filtrar menciones por categoría de sentimiento para priorizar las que requieren atención. | **Escenario 1 – Filtro negativo:** <br> **Given** el usuario selecciona la categoría "Negativo" <br> **When** el sistema aplica el filtro <br> **Then** muestra solo menciones negativas de más reciente a más antigua. <br><br> **Escenario 2 – Cambio de categoría:** <br> **Given** el filtro negativo está activo <br> **When** selecciona la categoría "Positivo" <br> **Then** actualiza el listado sin necesidad de recargar la página. <br><br> **Escenario 3 – Sin menciones en la categoría:** <br> **Given** la categoría seleccionada no tiene menciones <br> **When** aplica el filtro <br> **Then** muestra "No hay menciones en esta categoría." | EP04 |
| US14 | Ver tendencia de sentimiento | Como Agency Manager, quiero ver la evolución del sentimiento de una marca en el tiempo para evaluar el impacto de las acciones tomadas. | **Escenario 1 – Con datos históricos:** <br> **Given** la marca tiene menciones clasificadas en múltiples fechas <br> **When** accede al gráfico de tendencia <br> **Then** muestra curva de evolución por semana o mes con opción de ajustar el rango. <br><br> **Escenario 2 – Rango sin datos:** <br> **Given** el rango de fechas seleccionado no tiene menciones <br> **When** el sistema genera el gráfico <br> **Then** muestra "No hay datos de sentimiento para el período seleccionado." <br><br> **Escenario 3 – Comparación de períodos:** <br> **Given** el usuario selecciona dos períodos distintos <br> **When** el sistema procesa la solicitud <br> **Then** muestra ambas curvas diferenciadas por color con resumen de variación porcentual. | EP04 |
| EP05 | Gestión de Alertas | Generación de alertas automáticas ante menciones críticas, notificación y flujo de respuesta. | — | — |
| US15 | Recibir alertas de menciones críticas | Como PyME Owner o Agency Manager, quiero recibir alertas cuando se detecten menciones negativas críticas para poder actuar de forma inmediata. | **Escenario 1 – Alerta generada y notificada:** <br> **Given** el sistema detecta una mención negativa de alto impacto <br> **When** se genera la alerta <br> **Then** notifica dentro de la plataforma y por correo al responsable de la marca. <br><br> **Escenario 2 – Alerta ya revisada:** <br> **Given** la alerta fue marcada como atendida <br> **When** accede al panel de alertas <br> **Then** aparece en "Atendidas" y no genera notificaciones adicionales. <br><br> **Escenario 3 – Sin alertas recientes:** <br> **Given** sin menciones críticas en las últimas 24 horas <br> **When** accede al panel <br> **Then** muestra "Sin alertas críticas recientes." | EP05 |
| US16 | Configurar criterios de alerta | Como Agency Manager, quiero configurar los criterios de alerta (umbral de sentimiento y palabras clave críticas) para personalizar el monitoreo por cliente. | **Escenario 1 – Configuración guardada:** <br> **Given** palabras clave críticas y umbral mínimo definidos <br> **When** guarda la configuración <br> **Then** aplica los criterios al monitoreo y confirma "Criterios de alerta actualizados." <br><br> **Escenario 2 – Sin criterios definidos:** <br> **Given** sin ningún criterio configurado <br> **When** intenta activar las alertas <br> **Then** muestra "Debes definir al menos un criterio para activar las alertas." <br><br> **Escenario 3 – Criterio duplicado:** <br> **Given** la palabra clave ya está configurada como criterio <br> **When** intenta agregarla nuevamente <br> **Then** muestra "Esta palabra clave ya está configurada" y no genera duplicado. | EP05 |
| US17 | Responder mención desde una alerta | Como PyME Owner o Agency Manager, quiero responder a una mención directamente desde el detalle de una alerta para gestionar situaciones críticas de reputación. | **Escenario 1 – Respuesta registrada:** <br> **Given** el usuario redacta una respuesta en el campo habilitado <br> **When** confirma el envío <br> **Then** el sistema registra la respuesta con fecha/hora y actualiza la alerta a "Respondida." <br><br> **Escenario 2 – Respuesta vacía:** <br> **Given** el campo de respuesta está vacío <br> **When** confirma el envío <br> **Then** muestra "El campo de respuesta no puede estar vacío." <br><br> **Escenario 3 – Mención ya respondida:** <br> **Given** la mención ya tiene una respuesta registrada <br> **When** otro usuario intenta responderla <br> **Then** muestra "Esta mención ya fue respondida" con el historial de respuestas previas. | EP05 |
| EP06 | Reportes y Dashboard | Visualización del dashboard, generación, comparación y exportación de reportes de reputación. | — | — |
| US18 | Ver dashboard de reputación | Como PyME Owner o Agency Manager, quiero ver un dashboard con las métricas principales de reputación para tener una visión general rápida del estado actual. | **Escenario 1 – Dashboard con datos:** <br> **Given** la marca tiene menciones y análisis de sentimiento disponibles <br> **When** accede al dashboard <br> **Then** muestra volumen de menciones, distribución de sentimiento, alertas activas y tendencia reciente. <br><br> **Escenario 2 – Dashboard sin datos:** <br> **Given** la marca fue creada recientemente y no tiene menciones <br> **When** accede al dashboard <br> **Then** muestra widgets vacíos con "Comienza el monitoreo para ver los datos." <br><br> **Escenario 3 – Actualización del dashboard:** <br> **Given** hay nuevas menciones procesadas mientras el usuario visualiza <br> **When** hace clic en "Actualizar" <br> **Then** refresca los widgets sin recargar toda la página. | EP06 |
| US19 | Generar reporte de reputación | Como PyME Owner o Agency Manager, quiero generar un reporte de un período específico para documentar el desempeño de la marca. | **Escenario 1 – Reporte generado exitosamente:** <br> **Given** rango de fechas con datos disponibles seleccionado <br> **When** el sistema procesa la solicitud <br> **Then** genera el reporte con métricas de menciones, sentimiento y alertas y lo deja disponible para descarga. <br><br> **Escenario 2 – Sin datos en el período:** <br> **Given** el rango seleccionado no tiene menciones registradas <br> **When** solicita el reporte <br> **Then** muestra "No hay datos disponibles para el período seleccionado." <br><br> **Escenario 3 – Error de generación:** <br> **Given** fallo del sistema durante el proceso <br> **When** no puede completarse <br> **Then** muestra "No se pudo generar el reporte. Intenta nuevamente." | EP06 |
| US20 | Exportar reporte | Como Agency Manager, quiero exportar el reporte en PDF o CSV para compartirlo con clientes o equipo interno. | **Escenario 1 – Exportación en PDF:** <br> **Given** reporte generado y formato PDF seleccionado <br> **When** confirma la exportación <br> **Then** genera el archivo PDF y lo descarga automáticamente. <br><br> **Escenario 2 – Exportación en CSV:** <br> **Given** formato CSV seleccionado <br> **When** confirma la acción <br> **Then** genera el archivo CSV con datos tabulados y lo descarga automáticamente. <br><br> **Escenario 3 – Reporte no listo:** <br> **Given** el reporte aún está en proceso de generación <br> **When** hace clic en exportar <br> **Then** muestra "El reporte aún está siendo generado. Por favor espera." | EP06 |
| US21 | Comparar reputación entre períodos | Como Agency Manager, quiero comparar métricas de reputación entre dos períodos para evaluar la evolución e impacto de estrategias aplicadas. | **Escenario 1 – Comparación exitosa:** <br> **Given** dos períodos distintos con datos disponibles para la misma marca <br> **When** solicita la comparación <br> **Then** muestra cuadro comparativo con variaciones en menciones, sentimiento y alertas. <br><br> **Escenario 2 – Un período sin datos:** <br> **Given** uno de los períodos no tiene registros <br> **When** el sistema genera la comparación <br> **Then** muestra "El período seleccionado no tiene datos disponibles." <br><br> **Escenario 3 – Períodos iguales:** <br> **Given** el mismo rango de fechas en ambos campos <br> **When** intenta confirmar <br> **Then** muestra "Los períodos deben ser diferentes para realizar la comparación." | EP06 |
| EP07 | Landing Page | Sitio web estático informativo dirigido a visitantes PyME y de agencia digital. | — | — |
| US22 | Ver propuesta de valor en la landing page | Como visitante, quiero ver una sección inicial llamativa para entender rápidamente la propuesta de valor de BrandRadar antes de registrarme. | **Escenario 1 – Visualización correcta del hero:** <br> **Given** el visitante accede a la URL principal <br> **When** la página carga completamente <br> **Then** ve el titular, descripción del producto y botón "Comenzar gratis" visibles sin hacer scroll. <br><br> **Escenario 2 – Responsive móvil:** <br> **Given** el visitante accede desde un smartphone <br> **When** la página carga <br> **Then** el hero se adapta al ancho de la pantalla sin pérdida de información. <br><br> **Escenario 3 – Clic en llamada a la acción:** <br> **Given** el visitante hace clic en "Comenzar gratis" <br> **When** el sistema responde al clic <br> **Then** redirige al formulario de registro. | EP07 |
| US23 | Ver sección de funcionalidades para PyMEs | Como visitante del segmento PyME, quiero ver las funcionalidades clave de BrandRadar para evaluar si el producto cubre mis necesidades. | **Escenario 1 – Sección visible y completa:** <br> **Given** el visitante navega hacia la sección de funcionalidades <br> **When** la sección carga <br> **Then** muestra al menos tres funcionalidades (monitoreo, alertas, reportes) con ícono, título y descripción breve. <br><br> **Escenario 2 – Enlace de contacto disponible:** <br> **Given** el visitante desea más información <br> **When** hace clic en "Habla con nosotros" <br> **Then** redirige al formulario de contacto o correo de soporte. <br><br> **Escenario 3 – Navegación desde el menú:** <br> **Given** el visitante hace clic en "Funcionalidades" del menú de navegación <br> **When** el sistema responde <br> **Then** realiza scroll suave hasta la sección sin recargar la página. | EP07 |
| US24 | Ver sección para agencias en la landing page | Como visitante del segmento agencia, quiero ver contenido dirigido a agencias digitales para entender cómo BrandRadar optimiza la gestión de múltiples clientes. | **Escenario 1 – Sección para agencias visible:** <br> **Given** el visitante navega hasta la sección de agencias <br> **When** la sección carga <br> **Then** muestra beneficios multi-marca, reportes para clientes y alertas priorizadas con descripción clara. <br><br> **Escenario 2 – CTA diferenciado para agencias:** <br> **Given** el visitante hace clic en el botón de la sección <br> **When** el sistema responde <br> **Then** redirige al registro con tipo de cuenta "Agency Manager" preseleccionado. <br><br> **Escenario 3 – Sección visible en dispositivos móviles:** <br> **Given** el visitante accede desde un smartphone <br> **When** la sección carga <br> **Then** el contenido se muestra adaptado al ancho sin desbordamiento. | EP07 |
| US25 | Ver planes y precios en la landing page | Como visitante, quiero ver los planes y precios disponibles de BrandRadar para decidir cuál se adapta mejor a mis necesidades antes de registrarme. | **Escenario 1 – Tabla de precios visible:** <br> **Given** el visitante accede a la sección de precios <br> **When** la sección carga <br> **Then** muestra al menos dos planes con características, precio mensual y botón de acción individual. <br><br> **Escenario 2 – Diferenciación de plan recomendado:** <br> **Given** múltiples planes visibles en la sección <br> **When** el visitante visualiza <br> **Then** el plan recomendado está visualmente destacado con etiqueta o borde diferenciador. <br><br> **Escenario 3 – Clic en botón de plan:** <br> **Given** el visitante hace clic en el botón de un plan específico <br> **When** el sistema responde <br> **Then** redirige al formulario de registro con ese plan preseleccionado. | EP07 |
| US26 | Enviar mensaje de contacto desde la landing page | Como visitante, quiero enviar un mensaje de contacto a BrandRadar para resolver dudas antes de registrarme. | **Escenario 1 – Envío exitoso:** <br> **Given** todos los campos completados (nombre, correo, mensaje) <br> **When** hace clic en "Enviar" <br> **Then** el sistema registra el mensaje, muestra "Tu mensaje fue enviado. Te contactaremos pronto." y limpia el formulario. <br><br> **Escenario 2 – Correo inválido:** <br> **Given** formato de correo incorrecto en el formulario <br> **When** intenta enviar <br> **Then** resalta el campo con "Ingresa un correo válido" y no envía el formulario. <br><br> **Escenario 3 – Campos vacíos:** <br> **Given** algún campo obligatorio vacío <br> **When** hace clic en "Enviar" <br> **Then** resalta los campos vacíos y muestra "Completa todos los campos obligatorios." | EP07 |
| EP08 | Implementación Técnica y APIs | Endpoints de autenticación, marcas, menciones, sentimiento, alertas y reportes para garantizar que las funcionalidades estén disponibles de forma segura. | — | — |
| TS01 | Registro de usuario | Como Developer, quiero implementar el registro de nuevos usuarios para que la aplicación pueda crear cuentas mediante la API. | **Escenario 1 – Registro exitoso (201):** <br> **Given** nombre, correo y contraseña válidos enviados <br> **When** el servidor procesa la solicitud <br> **Then** responde 201 con el userId del nuevo usuario. <br><br> **Escenario 2 – Correo duplicado (409):** <br> **Given** el correo ya está registrado en el sistema <br> **When** el servidor procesa la solicitud <br> **Then** responde 409 con "El correo ya está registrado." <br><br> **Escenario 3 – Datos inválidos (400):** <br> **Given** campos faltantes o correo con formato incorrecto <br> **When** el servidor valida la entrada <br> **Then** responde 400 con detalle de los campos con error. | EP08 |
| TS02 | Inicio de sesión | Como Developer, quiero implementar el login de usuarios para que la aplicación pueda autenticar y generar tokens de acceso. | **Escenario 1 – Login exitoso (200):** <br> **Given** credenciales válidas de cuenta activa <br> **When** el servidor autentica <br> **Then** responde 200 con token JWT y tiempo de expiración. <br><br> **Escenario 2 – Credenciales inválidas (401):** <br> **Given** contraseña incorrecta para un correo registrado <br> **When** el servidor valida <br> **Then** responde 401 con "Credenciales inválidas." <br><br> **Escenario 3 – Cuenta no verificada (403):** <br> **Given** credenciales correctas de cuenta sin verificar <br> **When** el servidor procesa <br> **Then** responde 403 con "La cuenta no ha sido verificada." | EP08 |
| TS03 | Verificación de correo | Como Developer, quiero implementar la verificación de cuentas por token para que el enlace enviado al correo active la cuenta del usuario. | **Escenario 1 – Verificación exitosa (200):** <br> **Given** token válido y vigente <br> **When** el servidor lo valida <br> **Then** responde 200, activa la cuenta y retorna "Cuenta verificada exitosamente." <br><br> **Escenario 2 – Token expirado (400):** <br> **Given** token fuera de vigencia <br> **When** el servidor intenta validarlo <br> **Then** responde 400 con "El token de verificación ha expirado." <br><br> **Escenario 3 – Token inválido (404):** <br> **Given** token que no existe en el sistema <br> **When** el servidor lo busca <br> **Then** responde 404 con "Token de verificación no encontrado." | EP08 |
| TS04 | Creación de marca | Como Developer, quiero implementar el registro de marcas para que la aplicación pueda crear nuevas marcas asociadas a un usuario autenticado. | **Escenario 1 – Creación exitosa (201):** <br> **Given** solicitud autenticada con nombre, descripción y palabras clave válidos <br> **When** el servidor procesa <br> **Then** responde 201 con id y datos de la marca creada. <br><br> **Escenario 2 – Sin autenticación (401):** <br> **Given** solicitud sin token o con token inválido <br> **When** el servidor valida <br> **Then** responde 401 con "Autenticación requerida." <br><br> **Escenario 3 – Nombre duplicado (409):** <br> **Given** nombre de marca ya existente para ese usuario <br> **When** el servidor valida <br> **Then** responde 409 con "Ya existe una marca con ese nombre." | EP08 |
| TS05 | Consulta de marcas | Como Developer, quiero implementar la consulta de marcas para que la aplicación pueda obtener la lista de marcas del usuario autenticado. | **Escenario 1 – Lista retornada (200):** <br> **Given** solicitud autenticada <br> **When** el servidor procesa <br> **Then** responde 200 con arreglo de marcas (id, nombre, estado, menciones). <br><br> **Escenario 2 – Sin marcas (200 vacío):** <br> **Given** usuario sin marcas registradas <br> **When** el servidor consulta <br> **Then** responde 200 con arreglo vacío y "No hay marcas registradas." <br><br> **Escenario 3 – Sin autenticación (401):** <br> **Given** solicitud sin token válido <br> **When** el servidor verifica <br> **Then** responde 401. | EP08 |
| TS06 | Consulta de menciones | Como Developer, quiero implementar la consulta de menciones con filtros para que la aplicación pueda obtener menciones por fecha, fuente y sentimiento. | **Escenario 1 – Consulta con filtros (200):** <br> **Given** parámetros válidos (dateFrom, dateTo, source, sentiment) <br> **When** el servidor procesa <br> **Then** responde 200 con listado paginado de menciones que cumplen los criterios. <br><br> **Escenario 2 – Marca no encontrada (404):** <br> **Given** id de marca inexistente o no perteneciente al usuario <br> **When** el servidor busca <br> **Then** responde 404 con "Marca no encontrada." <br><br> **Escenario 3 – Sin resultados (200 vacío):** <br> **Given** filtros sin coincidencias <br> **When** el servidor ejecuta la consulta <br> **Then** responde 200 con arreglo vacío. | EP08 |
| TS07 | Análisis de sentimiento | Como Developer, quiero implementar la consulta de sentimiento para que la aplicación pueda obtener el resumen de sentimiento de una marca por rango de fechas. | **Escenario 1 – Análisis retornado (200):** <br> **Given** rango de fechas válido con menciones clasificadas <br> **When** el servidor procesa <br> **Then** responde 200 con porcentajes positivo/negativo/neutro y score general. <br><br> **Escenario 2 – Sin datos (404):** <br> **Given** rango sin menciones clasificadas <br> **When** el servidor consulta <br> **Then** responde 404 con "No hay datos de sentimiento para el período." <br><br> **Escenario 3 – Fechas inválidas (400):** <br> **Given** formato incorrecto o fecha inicio mayor a fecha fin <br> **When** el servidor valida <br> **Then** responde 400 con descripción del error de validación. | EP08 |
| TS08 | Consulta de alertas | Como Developer, quiero implementar la consulta de alertas para que la aplicación pueda obtener las alertas activas e históricas de una marca. | **Escenario 1 – Alertas retornadas (200):** <br> **Given** marca con alertas registradas <br> **When** el servidor procesa <br> **Then** responde 200 con listado de alertas (id, tipo, estado, mención, fecha). <br><br> **Escenario 2 – Sin alertas (200 vacío):** <br> **Given** marca sin alertas registradas <br> **When** el servidor consulta <br> **Then** responde 200 con arreglo vacío. <br><br> **Escenario 3 – Sin autenticación (401):** <br> **Given** solicitud sin token válido <br> **When** el servidor valida <br> **Then** responde 401. | EP08 |
| TS09 | Respuesta a alerta | Como Developer, quiero implementar el registro de respuestas a alertas para que la aplicación pueda actualizar el estado de una alerta al ser atendida. | **Escenario 1 – Respuesta registrada (200):** <br> **Given** id de alerta válido y contenido de respuesta incluido <br> **When** el servidor procesa <br> **Then** responde 200 con alerta en estado "Respondida" y datos de la respuesta. <br><br> **Escenario 2 – Alerta no encontrada (404):** <br> **Given** id de alerta inexistente o no perteneciente al usuario <br> **When** el servidor busca <br> **Then** responde 404 con "Alerta no encontrada." <br><br> **Escenario 3 – Respuesta vacía (400):** <br> **Given** campo de respuesta vacío o ausente <br> **When** el servidor valida <br> **Then** responde 400 con "El contenido de la respuesta es requerido." | EP08 |
| TS10 | Generación de reporte | Como Developer, quiero implementar la generación de reportes para que la aplicación pueda crear un reporte de reputación de un período específico. | **Escenario 1 – Reporte generado (201):** <br> **Given** rango de fechas válido con datos disponibles <br> **When** el servidor procesa <br> **Then** responde 201 con id del reporte y enlace de descarga. <br><br> **Escenario 2 – Sin datos en el período (404):** <br> **Given** rango de fechas sin menciones registradas <br> **When** el servidor ejecuta <br> **Then** responde 404 con "No hay datos disponibles para el período indicado." <br><br> **Escenario 3 – Solicitud inválida (400):** <br> **Given** fechas faltantes o con formato incorrecto <br> **When** el servidor valida <br> **Then** responde 400 con descripción del error. | EP08 |
| TS11 | Exportación de reporte | Como Developer, quiero implementar la exportación de reportes para que la aplicación pueda descargar un reporte en formato PDF o CSV. | **Escenario 1 – Exportación exitosa (200):** <br> **Given** id de reporte existente y formato "pdf" o "csv" indicado <br> **When** el servidor genera el archivo <br> **Then** responde 200 con el archivo adjunto en el Content-Type correspondiente. <br><br> **Escenario 2 – Formato no soportado (400):** <br> **Given** valor de formato distinto a pdf o csv <br> **When** el servidor valida el parámetro <br> **Then** responde 400 con "Formato no soportado. Usa pdf o csv." <br><br> **Escenario 3 – Reporte no encontrado (404):** <br> **Given** id de reporte inexistente o no perteneciente al usuario <br> **When** el servidor busca <br> **Then** responde 404 con "Reporte no encontrado." | EP08 |
