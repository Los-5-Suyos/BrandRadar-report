...
|:-------:|--------|-------------|------------------------|
| EP01 | Landing Page | Sitio web estático informativo con propuesta de valor, funcionalidades, precios, testimonios y contacto, dirigido a visitantes PyME y de agencia digital. | US01, US02, US03, US04, US05 |
| EP02 | Gestión de Cuentas | Funcionalidad completa de registro, verificación de correo, autenticación, recuperación de contraseña y cierre de sesión, abarcando interfaz Angular y endpoints Spring Boot. | US06, US07, US08, US09, US10, TS01, TS02, TS03, TS04, TS05 |
| EP03 | Configuración de Marca | Funcionalidad completa de creación, edición, eliminación y configuración de marcas con palabras clave y fuentes de datos, abarcando interfaz Angular y endpoints Spring Boot. | US11, US12, US13, US14, US15, TS06, TS07, TS08 |
| EP04 | Monitoreo de Menciones | Funcionalidad completa de inicio de monitoreo, recolección, listado, filtrado y paginación de menciones, abarcando interfaz Angular y endpoints Spring Boot. | US16, US17, US18, TS09 |
| EP05 | Análisis de Sentimiento | Funcionalidad completa de análisis general de sentimiento, filtrado por categoría y tendencias en el tiempo, abarcando interfaz Angular y endpoints Spring Boot. | US19, US20, US21, TS10 |
| EP06 | Gestión de Alertas | Funcionalidad completa de panel de alertas, configuración de criterios y respuesta a menciones críticas, abarcando interfaz Angular y endpoints Spring Boot. | US22, US23, US24, TS11, TS12 |
| EP07 | Reportes y Dashboard | Funcionalidad completa de dashboard de reputación, generación, historial, comparación y exportación de reportes, abarcando interfaz Angular y endpoints Spring Boot. | US25, US26, US27, US28, US29, TS13, TS14, TS15 |
...
|:---------------:|--------|-------------|-------------------------|:-------------------------:|
| **EP01** | **Landing Page** | Sitio web estático informativo con propuesta de valor, funcionalidades, precios, testimonios y contacto. | — | — |
| US01 | Ver propuesta de valor en la landing page | Como visitante de la landing page, quiero ver claramente el propósito y los beneficios de BrandRadar para entender cómo puede ayudarme antes de registrarme. | **Escenario 1 – Visualización correcta del hero:**<br>**Given** el visitante accede a la URL principal de BrandRadar<br>**When** la página carga completamente<br>**Then** ve el titular de la propuesta de valor, descripción del producto y botón "Comenzar gratis" visible sin hacer scroll.<br><br>**Escenario 2 – Visualización en dispositivo móvil:**<br>**Given** el visitante accede desde un smartphone<br>**When** la página carga<br>**Then** el contenido del hero se adapta al ancho de la pantalla sin pérdida de información.<br><br>**Escenario 3 – Clic en llamada a la acción:**<br>**Given** el visitante hace clic en "Comenzar gratis"<br>**When** el sistema responde al clic<br>**Then** redirige al formulario de registro de la aplicación web. | EP01 |
| US02 | Ver sección de funcionalidades | Como visitante de la landing page, quiero ver las funcionalidades principales de BrandRadar para evaluar si el producto cubre mis necesidades antes de registrarme. | **Escenario 1 – Sección visible y completa:**<br>**Given** el visitante navega hacia la sección de funcionalidades<br>**When** la sección carga<br>**Then** muestra al menos tres funcionalidades clave (monitoreo, alertas, reportes) con ícono, título y descripción breve.<br><br>**Escenario 2 – Sección para agencias visible:**<br>**Given** el visitante navega hasta la sección orientada a agencias<br>**When** la sección carga<br>**Then** muestra los beneficios específicos para agencias (gestión multi-marca, reportes para clientes, alertas priorizadas).<br><br>**Escenario 3 – Navegación desde el menú:**<br>**Given** el visitante hace clic en "Funcionalidades" del menú de navegación<br>**When** el sistema responde<br>**Then** realiza scroll suave hasta la sección sin recargar la página. | EP01 |
| US03 | Ver testimonios en la landing page | Como visitante de la landing page, quiero ver testimonios de otros usuarios de BrandRadar para generar confianza antes de registrarme. | **Escenario 1 – Sección de testimonios visible:**<br>**Given** el visitante llega a la sección de testimonios<br>**When** la sección carga<br>**Then** muestra al menos dos testimonios con nombre, tipo de usuario (PyME o agencia) y descripción de su experiencia.<br><br>**Escenario 2 – Visualización en móvil:**<br>**Given** el visitante accede desde un smartphone<br>**When** la sección de testimonios carga<br>**Then** los testimonios se muestran en formato adaptado sin desbordamiento ni pérdida de contenido.<br><br>**Escenario 3 – Navegación entre testimonios:**<br>**Given** hay más de dos testimonios disponibles<br>**When** el visitante hace clic en los controles de navegación<br>**Then** el sistema avanza o retrocede entre testimonios sin recargar la página. | EP01 |
| US04 | Ver planes y precios en la landing page | Como visitante de la landing page, quiero ver los planes y precios disponibles de BrandRadar para decidir cuál se adapta mejor a mis necesidades. | **Escenario 1 – Tabla de precios visible:**<br>**Given** el visitante accede a la sección de precios<br>**When** la sección carga<br>**Then** muestra al menos dos planes con características incluidas, precio mensual y botón de acción individual.<br><br>**Escenario 2 – Plan recomendado destacado:**<br>**Given** hay múltiples planes visibles en la sección<br>**When** el visitante visualiza la sección<br>**Then** el plan recomendado está visualmente destacado con una etiqueta o borde diferenciador.<br><br>**Escenario 3 – Clic en botón de plan:**<br>**Given** el visitante hace clic en el botón de un plan específico<br>**When** el sistema responde al clic<br>**Then** redirige al formulario de registro con ese plan preseleccionado. | EP01 |
| US05 | Enviar mensaje de contacto desde la landing page | Como visitante de la landing page, quiero enviar un mensaje de contacto a BrandRadar para resolver dudas antes de registrarme. | **Escenario 1 – Envío exitoso:**<br>**Given** el visitante completa todos los campos del formulario (nombre, correo y mensaje)<br>**When** hace clic en "Enviar"<br>**Then** el sistema muestra "Tu mensaje fue enviado. Te contactaremos pronto." y limpia el formulario.<br><br>**Escenario 2 – Correo inválido:**<br>**Given** el visitante ingresa un formato de correo incorrecto<br>**When** intenta enviar el formulario<br>**Then** resalta el campo con "Ingresa un correo válido" y no envía el formulario.<br><br>**Escenario 3 – Campos vacíos:**<br>**Given** el visitante intenta enviar el formulario con algún campo obligatorio vacío<br>**When** hace clic en "Enviar"<br>**Then** resalta los campos vacíos y muestra "Completa todos los campos obligatorios." | EP01 |
| **EP02** | **Gestión de Cuentas** | Funcionalidad completa de registro, verificación, autenticación y cierre de sesión abarcando interfaz Angular y endpoints Spring Boot. | — | — |
| US06 | Registrar cuenta | Como PyME Owner o Agency Manager, quiero crear una cuenta con mis datos básicos para acceder a las funcionalidades de monitoreo de reputación de BrandRadar. | **Escenario 1 – Registro exitoso:**<br>**Given** el usuario completa todos los campos requeridos (nombre, correo, contraseña y tipo de cuenta) en el formulario de registro<br>**When** envía el formulario<br>**Then** el sistema crea la cuenta, envía el correo de verificación y redirige a la vista de confirmación con el mensaje "Cuenta creada. Revisa tu correo para verificarla."<br><br>**Escenario 2 – Validación en tiempo real:**<br>**Given** el usuario ingresa una contraseña que no cumple los requisitos<br>**When** escribe en el campo<br>**Then** el sistema resalta el campo y muestra el mensaje de requisitos incumplidos sin enviar el formulario.<br><br>**Escenario 3 – Correo duplicado:**<br>**Given** el usuario ingresa un correo ya registrado<br>**When** envía el formulario<br>**Then** el sistema muestra "El correo ya está registrado." sin recargar la página. | EP02 |
| US07 | Verificar correo electrónico | Como usuario recién registrado, quiero verificar mi correo electrónico para activar mi cuenta y acceder a BrandRadar. | **Escenario 1 – Verificación exitosa:**<br>**Given** el usuario hace clic en el enlace de verificación en su correo<br>**When** el sistema procesa el token en la URL<br>**Then** muestra la confirmación "Correo verificado exitosamente" y un botón para ir al login.<br><br>**Escenario 2 – Token expirado:**<br>**Given** el token en la URL ya expiró<br>**When** el sistema lo valida<br>**Then** muestra "El enlace ha expirado" y un botón "Reenviar correo de verificación."<br><br>**Escenario 3 – Token inválido:**<br>**Given** el token en la URL es incorrecto o manipulado<br>**When** el sistema lo valida<br>**Then** muestra "Enlace de verificación inválido" sin redirigir al login. | EP02 |
| US08 | Iniciar sesión | Como PyME Owner o Agency Manager con cuenta verificada, quiero iniciar sesión para acceder a mi panel de monitoreo de reputación en BrandRadar. | **Escenario 1 – Login exitoso:**<br>**Given** el usuario ingresa credenciales válidas en el formulario de login<br>**When** el sistema autentica la solicitud<br>**Then** almacena el token de sesión y redirige al dashboard principal.<br><br>**Escenario 2 – Credenciales incorrectas:**<br>**Given** el usuario ingresa una contraseña incorrecta<br>**When** el sistema valida las credenciales<br>**Then** muestra "Correo o contraseña incorrectos" debajo del formulario sin recargar la página.<br><br>**Escenario 3 – Cuenta no verificada:**<br>**Given** el usuario intenta ingresar con una cuenta sin verificar<br>**When** el sistema valida el estado de la cuenta<br>**Then** muestra "Debes verificar tu correo antes de iniciar sesión" con opción de reenviar el correo. | EP02 |
| US09 | Recuperar contraseña | Como usuario registrado, quiero recuperar el acceso a mi cuenta mediante un correo de restablecimiento para poder ingresar si olvidé mi contraseña. | **Escenario 1 – Solicitud enviada:**<br>**Given** el usuario ingresa su correo en el formulario de recuperación<br>**When** el sistema procesa la solicitud<br>**Then** muestra "Revisa tu correo para restablecer tu contraseña." independientemente de si el correo existe o no.<br><br>**Escenario 2 – Restablecimiento exitoso:**<br>**Given** el usuario completa el formulario de nueva contraseña con valores válidos<br>**When** el sistema procesa la solicitud<br>**Then** muestra "Contraseña actualizada exitosamente" y redirige al login.<br><br>**Escenario 3 – Enlace expirado:**<br>**Given** el usuario accede a un enlace de restablecimiento vencido<br>**When** el sistema valida el token<br>**Then** muestra "El enlace de recuperación ha expirado" con opción de solicitar uno nuevo. | EP02 |
| US10 | Cerrar sesión | Como usuario autenticado, quiero cerrar sesión para proteger el acceso a mi cuenta desde dispositivos compartidos. | **Escenario 1 – Cierre exitoso:**<br>**Given** el usuario autenticado hace clic en "Cerrar sesión"<br>**When** el sistema ejecuta la acción<br>**Then** elimina el token de sesión, limpia el estado y redirige al login.<br><br>**Escenario 2 – Sesión expirada:**<br>**Given** el token del usuario expiró durante la navegación<br>**When** el sistema detecta el token inválido<br>**Then** redirige automáticamente al login sin mostrar datos protegidos.<br><br>**Escenario 3 – Múltiples pestañas:**<br>**Given** el usuario cierra sesión en una pestaña<br>**When** intenta navegar en otra pestaña con BrandRadar abierto<br>**Then** el sistema detecta el token inválido y redirige al login. | EP02 |
| TS01 | Endpoint de registro de usuario | Como Developer, quiero implementar el endpoint de registro en Spring Boot para que la aplicación pueda crear nuevas cuentas de usuario. | **Escenario 1 – Registro exitoso (201):**<br>**Given** nombre, correo y contraseña válidos en el body del POST /api/v1/auth/register<br>**When** el servidor procesa la solicitud<br>**Then** crea el usuario, envía el correo de verificación y retorna 201 con el userId.<br><br>**Escenario 2 – Correo duplicado (409):**<br>**Given** el correo ya existe en la base de datos<br>**When** el servidor procesa la solicitud<br>**Then** retorna 409 con "El correo ya está registrado."<br><br>**Escenario 3 – Datos inválidos (400):**<br>**Given** campos faltantes o correo con formato incorrecto<br>**When** el servidor valida la entrada<br>**Then** retorna 400 con el detalle de los campos con error. | EP02 |
| TS02 | Endpoint de inicio de sesión y emisión de JWT | Como Developer, quiero implementar el endpoint de login en Spring Boot para autenticar usuarios y emitir tokens JWT. | **Escenario 1 – Login exitoso (200):**<br>**Given** correo y contraseña válidos de una cuenta verificada en el POST /api/v1/auth/login<br>**When** el servidor autentica<br>**Then** retorna 200 con el token JWT, refresh token y tiempo de expiración.<br><br>**Escenario 2 – Credenciales inválidas (401):**<br>**Given** contraseña incorrecta<br>**When** el servidor valida<br>**Then** retorna 401 con "Credenciales inválidas."<br><br>**Escenario 3 – Cuenta no verificada (403):**<br>**Given** credenciales correctas de cuenta sin verificar<br>**When** el servidor procesa<br>**Then** retorna 403 con "La cuenta no ha sido verificada." | EP02 |
| TS03 | Endpoint de verificación de correo | Como Developer, quiero implementar el endpoint de verificación de token en Spring Boot para activar las cuentas de usuario. | **Escenario 1 – Verificación exitosa (200):**<br>**Given** token válido y vigente en el GET /api/v1/auth/verify?token={token}<br>**When** el servidor lo procesa<br>**Then** activa la cuenta y retorna 200.<br><br>**Escenario 2 – Token expirado (400):**<br>**Given** token vencido<br>**When** el servidor lo valida<br>**Then** retorna 400 con "El token de verificación ha expirado."<br><br>**Escenario 3 – Token inválido (404):**<br>**Given** token inexistente<br>**When** el servidor lo busca<br>**Then** retorna 404 con "Token de verificación no encontrado." | EP02 |
| TS04 | Endpoint de recuperación de contraseña | Como Developer, quiero implementar el flujo de recuperación de contraseña en Spring Boot para que los usuarios puedan restablecer su acceso. | **Escenario 1 – Solicitud enviada (200):**<br>**Given** correo registrado en el POST /api/v1/auth/forgot-password<br>**When** el servidor procesa<br>**Then** genera token con expiración de 1 hora, envía correo y retorna 200.<br><br>**Escenario 2 – Restablecimiento exitoso (200):**<br>**Given** token válido y nueva contraseña en el POST /api/v1/auth/reset-password<br>**When** el servidor procesa<br>**Then** actualiza la contraseña, invalida el token y retorna 200.<br><br>**Escenario 3 – Token expirado (400):**<br>**Given** token vencido<br>**When** el servidor lo valida<br>**Then** retorna 400 con "El enlace de recuperación ha expirado." | EP02 |
| TS05 | Endpoint de refresh de token JWT | Como Developer, quiero implementar el endpoint de renovación de token en Spring Boot para mantener la sesión activa sin requerir un nuevo login. | **Escenario 1 – Refresh exitoso (200):**<br>**Given** refresh token válido en el POST /api/v1/auth/refresh<br>**When** el servidor lo valida<br>**Then** emite nuevo JWT, invalida el anterior y retorna 200.<br><br>**Escenario 2 – Token inválido (401):**<br>**Given** refresh token manipulado<br>**When** el servidor lo valida<br>**Then** retorna 401 con "Refresh token inválido."<br><br>**Escenario 3 – Token expirado (401):**<br>**Given** refresh token vencido<br>**When** el servidor lo valida<br>**Then** retorna 401 con "La sesión ha expirado. Inicia sesión nuevamente." | EP02 |
| **EP03** | **Configuración de Marca** | Funcionalidad completa de creación, edición, eliminación y configuración de marcas con palabras clave y fuentes de datos, abarcando interfaz Angular y endpoints Spring Boot. | — | — |
| US11 | Crear perfil de marca | Como PyME Owner o Agency Manager, quiero crear el perfil de mi marca con información básica y palabras clave para que BrandRadar comience a monitorizarla. | **Escenario 1 – Creación exitosa:**<br>**Given** el usuario completa los campos requeridos (nombre, descripción y palabras clave) y envía el formulario<br>**When** el sistema procesa la solicitud<br>**Then** crea la marca, muestra "Marca creada exitosamente" y redirige al listado de marcas.<br><br>**Escenario 2 – Nombre duplicado:**<br>**Given** el usuario ingresa un nombre de marca ya existente en su cuenta<br>**When** el sistema valida<br>**Then** muestra "Ya tienes una marca con ese nombre" sin recargar la vista.<br><br>**Escenario 3 – Campos inválidos:**<br>**Given** el usuario intenta enviar el formulario con el nombre vacío<br>**When** el sistema valida<br>**Then** resalta el campo con "El nombre de la marca es obligatorio." | EP03 |
| US12 | Editar perfil de marca | Como PyME Owner o Agency Manager, quiero editar la información de una marca existente para mantener sus datos actualizados. | **Escenario 1 – Edición exitosa:**<br>**Given** el usuario modifica los datos de la marca con valores válidos y guarda<br>**When** el sistema procesa la solicitud<br>**Then** actualiza la marca y muestra "Marca actualizada correctamente."<br><br>**Escenario 2 – Formulario precargado:**<br>**Given** el usuario accede a la vista de edición de una marca<br>**When** el sistema carga la vista<br>**Then** los campos aparecen precargados con los datos actuales de la marca.<br><br>**Escenario 3 – Campo vacío:**<br>**Given** el usuario borra el nombre dejando el campo vacío e intenta guardar<br>**When** el sistema valida<br>**Then** muestra "El nombre de la marca es obligatorio." sin enviar la solicitud. | EP03 |
| US13 | Eliminar marca | Como PyME Owner o Agency Manager, quiero eliminar una marca de mi panel para mantener solo las que están activas. | **Escenario 1 – Confirmación antes de eliminar:**<br>**Given** el usuario hace clic en el botón eliminar de una marca<br>**When** el sistema responde<br>**Then** muestra un diálogo "¿Estás seguro de que deseas eliminar esta marca? Esta acción no se puede deshacer."<br><br>**Escenario 2 – Eliminación exitosa:**<br>**Given** el usuario confirma la eliminación<br>**When** el sistema procesa la solicitud<br>**Then** elimina la marca del listado y muestra "Marca eliminada correctamente."<br><br>**Escenario 3 – Cancelación sin cambios:**<br>**Given** el usuario hace clic en "Cancelar" en el diálogo<br>**When** el sistema responde<br>**Then** cierra el diálogo y mantiene la marca en el listado. | EP03 |
| US14 | Configurar palabras clave de monitoreo | Como PyME Owner o Agency Manager, quiero configurar y editar las palabras clave de una marca para que el monitoreo capture las menciones relevantes. | **Escenario 1 – Adición exitosa:**<br>**Given** el usuario escribe una nueva palabra clave y confirma<br>**When** el sistema procesa la solicitud<br>**Then** agrega la etiqueta al listado y muestra "Palabras clave actualizadas correctamente."<br><br>**Escenario 2 – Palabra clave duplicada:**<br>**Given** el usuario intenta agregar una palabra clave ya existente<br>**When** el sistema valida<br>**Then** muestra "Esta palabra clave ya fue agregada" sin enviar la solicitud.<br><br>**Escenario 3 – Listado visible:**<br>**Given** el usuario accede a la configuración de palabras clave<br>**When** la vista carga<br>**Then** muestra las palabras clave existentes como etiquetas con opción de eliminar cada una. | EP03 |
| US15 | Conectar fuentes de datos | Como PyME Owner o Agency Manager, quiero conectar plataformas digitales a una marca para que BrandRadar recolecte menciones de esas fuentes. | **Escenario 1 – Conexión exitosa:**<br>**Given** el usuario ingresa credenciales válidas de una plataforma y confirma la conexión<br>**When** el sistema valida con el servicio externo<br>**Then** actualiza el estado a "Conectado" sin recargar la vista.<br><br>**Escenario 2 – Error de credenciales:**<br>**Given** el usuario ingresa credenciales incorrectas<br>**When** el sistema intenta validarlas<br>**Then** muestra "No se pudo conectar. Verifica tus credenciales." sin cerrar el formulario.<br><br>**Escenario 3 – Estado visible:**<br>**Given** el usuario accede a la vista de fuentes de datos<br>**When** la vista carga<br>**Then** muestra cada plataforma con su estado actual (Conectado / No conectado) y botón de acción. | EP03 |
| TS06 | Endpoints de creación y consulta de marcas | Como Developer, quiero implementar los endpoints de creación y consulta de marcas en Spring Boot para registrar y listar marcas del usuario autenticado. | **Escenario 1 – Creación exitosa (201):**<br>**Given** solicitud autenticada con datos válidos en el POST /api/v1/brands<br>**When** el servidor procesa<br>**Then** persiste la marca y retorna 201 con id y datos.<br><br>**Escenario 2 – Lista retornada (200):**<br>**Given** solicitud GET autenticada a /api/v1/brands<br>**When** el servidor procesa<br>**Then** retorna 200 con el arreglo de marcas del usuario.<br><br>**Escenario 3 – Nombre duplicado (409):**<br>**Given** nombre ya existente<br>**When** el servidor valida<br>**Then** retorna 409 con "Ya existe una marca con ese nombre." | EP03 |
| TS07 | Endpoints de edición y eliminación de marcas | Como Developer, quiero implementar los endpoints de edición y eliminación de marcas en Spring Boot para completar el CRUD de marcas. | **Escenario 1 – Edición exitosa (200):**<br>**Given** solicitud PUT autenticada con datos válidos a /api/v1/brands/{id}<br>**When** el servidor procesa<br>**Then** actualiza y retorna 200 con datos actualizados.<br><br>**Escenario 2 – Eliminación exitosa (200):**<br>**Given** solicitud DELETE autenticada a /api/v1/brands/{id}<br>**When** el servidor procesa<br>**Then** elimina la marca y retorna 200.<br><br>**Escenario 3 – No encontrada (404):**<br>**Given** id inexistente<br>**When** el servidor busca<br>**Then** retorna 404 con "Marca no encontrada." | EP03 |
| TS08 | Endpoints de palabras clave y fuentes de datos | Como Developer, quiero implementar los endpoints de palabras clave y fuentes de datos en Spring Boot para configurar el monitoreo de cada marca. | **Escenario 1 – Palabras clave actualizadas (200):**<br>**Given** solicitud autenticada con arreglo válido en el PUT /api/v1/brands/{id}/keywords<br>**When** el servidor procesa<br>**Then** actualiza y retorna 200 con la lista actualizada.<br><br>**Escenario 2 – Fuente conectada (200):**<br>**Given** credenciales válidas en el POST /api/v1/brands/{id}/sources<br>**When** el servidor valida con el servicio externo<br>**Then** persiste y retorna 200 con estado "Conectado."<br><br>**Escenario 3 – Credenciales inválidas (400):**<br>**Given** credenciales incorrectas<br>**When** el servidor intenta validarlas<br>**Then** retorna 400 con "No se pudo conectar. Verifica tus credenciales." | EP03 |
| **EP04** | **Monitoreo de Menciones** | Funcionalidad completa de inicio de monitoreo, recolección, listado, filtrado y paginación de menciones, abarcando interfaz Angular y endpoints Spring Boot. | — | — |
| US16 | Iniciar monitoreo de marca | Como PyME Owner o Agency Manager, quiero iniciar el monitoreo de una marca configurada para que BrandRadar recolecte menciones en tiempo real. | **Escenario 1 – Activación exitosa:**<br>**Given** la marca tiene al menos una palabra clave y una fuente conectada<br>**When** el usuario hace clic en "Iniciar monitoreo"<br>**Then** el sistema activa el monitoreo y muestra el estado "Monitoreando" con la fecha y hora de inicio.<br><br>**Escenario 2 – Botón deshabilitado:**<br>**Given** la marca no tiene fuentes conectadas<br>**When** el usuario accede a la vista de la marca<br>**Then** el botón "Iniciar monitoreo" aparece deshabilitado con el aviso "Conecta al menos una fuente de datos."<br><br>**Escenario 3 – Estado persistido:**<br>**Given** el monitoreo fue activado previamente<br>**When** el usuario regresa a la vista de la marca<br>**Then** el sistema muestra el estado "Monitoreando" con la fecha de inicio original. | EP04 |
| US17 | Visualizar menciones recolectadas | Como PyME Owner o Agency Manager, quiero ver el listado de menciones recolectadas para estar al tanto de lo que se dice sobre mi marca en internet. | **Escenario 1 – Listado paginado:**<br>**Given** el sistema tiene menciones recolectadas para la marca<br>**When** el usuario accede a la vista de menciones<br>**Then** muestra cada mención con fuente, fecha, texto y etiqueta de sentimiento, ordenadas de más reciente a más antigua con controles de paginación.<br><br>**Escenario 2 – Estado vacío:**<br>**Given** el monitoreo está activo pero sin menciones aún<br>**When** el usuario accede<br>**Then** muestra "No se han encontrado menciones aún. El monitoreo está en proceso."<br><br>**Escenario 3 – Aviso de fuente con error:**<br>**Given** una fuente presenta falla durante el monitoreo<br>**When** el usuario accede al listado<br>**Then** muestra un aviso indicando la fuente con error y continúa mostrando menciones de las demás fuentes. | EP04 |
| US18 | Filtrar menciones por criterio | Como PyME Owner o Agency Manager, quiero filtrar menciones por fecha, fuente o sentimiento para encontrar rápidamente las más relevantes. | **Escenario 1 – Filtros aplicados:**<br>**Given** el usuario selecciona uno o más filtros<br>**When** el sistema procesa la selección<br>**Then** actualiza el listado mostrando solo las menciones que cumplen los criterios y reinicia la paginación a la primera página.<br><br>**Escenario 2 – Sin coincidencias:**<br>**Given** los filtros no coinciden con ninguna mención<br>**When** el sistema procesa<br>**Then** muestra "No hay menciones que coincidan con los filtros aplicados."<br><br>**Escenario 3 – Limpiar filtros:**<br>**Given** hay filtros activos<br>**When** el usuario hace clic en "Limpiar filtros"<br>**Then** el sistema elimina todos los filtros y restaura el listado completo desde la primera página. | EP04 |
| TS09 | Endpoints de monitoreo y consulta paginada de menciones | Como Developer, quiero implementar los endpoints de inicio de monitoreo y consulta paginada de menciones en Spring Boot para habilitar la recolección y visualización de datos. | **Escenario 1 – Inicio de monitoreo (200):**<br>**Given** solicitud autenticada al POST /api/v1/brands/{id}/monitoring/start con marca configurada<br>**When** el servidor procesa<br>**Then** activa el monitoreo y retorna 200 con fecha y hora de inicio.<br><br>**Escenario 2 – Consulta paginada (200):**<br>**Given** solicitud GET a /api/v1/brands/{id}/mentions con parámetros válidos<br>**When** el servidor procesa<br>**Then** retorna 200 con listado paginado incluyendo totalElements, totalPages y página actual.<br><br>**Escenario 3 – Configuración incompleta (400):**<br>**Given** la marca no tiene fuentes conectadas<br>**When** el servidor valida<br>**Then** retorna 400 con "Conecta al menos una fuente de datos antes de iniciar el monitoreo." | EP04 |
| **EP05** | **Análisis de Sentimiento** | Funcionalidad completa de análisis general de sentimiento, filtrado por categoría y tendencias en el tiempo, abarcando interfaz Angular y endpoints Spring Boot. | — | — |
| US19 | Ver análisis de sentimiento general | Como PyME Owner o Agency Manager, quiero ver el análisis de sentimiento general de mi marca para entender cómo está siendo percibida en internet. | **Escenario 1 – Gráfico de distribución:**<br>**Given** la marca tiene menciones clasificadas<br>**When** el usuario accede a la vista de análisis<br>**Then** muestra la distribución porcentual de menciones positivas, negativas y neutras.<br><br>**Escenario 2 – Estado de carga:**<br>**Given** el sistema aún procesa menciones recientes<br>**When** el usuario accede<br>**Then** muestra un indicador de carga con "Análisis en proceso" junto a los datos disponibles.<br><br>**Escenario 3 – Datos insuficientes:**<br>**Given** la marca tiene menos de 5 menciones recolectadas<br>**When** el usuario accede<br>**Then** muestra "Datos insuficientes. El análisis estará disponible cuando se recolecten más menciones." | EP05 |
| US20 | Ver menciones por categoría de sentimiento | Como PyME Owner o Agency Manager, quiero filtrar menciones según su categoría de sentimiento para priorizar las que requieren atención inmediata. | **Escenario 1 – Filtro aplicado:**<br>**Given** el usuario selecciona una categoría de sentimiento<br>**When** el sistema procesa<br>**Then** muestra solo las menciones de esa categoría ordenadas de más reciente a más antigua.<br><br>**Escenario 2 – Cambio de categoría:**<br>**Given** un filtro de sentimiento está activo<br>**When** el usuario selecciona otra categoría<br>**Then** el sistema actualiza el listado sin recargar la página.<br><br>**Escenario 3 – Categoría vacía:**<br>**Given** la categoría seleccionada no tiene menciones<br>**When** el sistema procesa<br>**Then** muestra "No hay menciones en esta categoría." | EP05 |
| US21 | Ver tendencia de sentimiento en el tiempo | Como Agency Manager, quiero ver la evolución del sentimiento de una marca a lo largo del tiempo para evaluar el impacto de las acciones tomadas. | **Escenario 1 – Gráfico con rango por defecto:**<br>**Given** la marca tiene menciones en múltiples fechas<br>**When** el usuario accede a la vista de tendencias<br>**Then** muestra la curva de evolución del sentimiento con los últimos 30 días por defecto.<br><br>**Escenario 2 – Rango personalizado:**<br>**Given** el usuario selecciona un rango de fechas personalizado<br>**When** el sistema procesa<br>**Then** actualiza el gráfico con los datos del nuevo rango.<br><br>**Escenario 3 – Comparación de períodos:**<br>**Given** el usuario activa el modo comparación y selecciona dos períodos<br>**When** el sistema procesa<br>**Then** muestra ambas curvas diferenciadas por color con la variación porcentual. | EP05 |
| TS10 | Endpoints de análisis de sentimiento y tendencias | Como Developer, quiero implementar los endpoints de análisis de sentimiento y tendencias en Spring Boot para consultar el estado reputacional de una marca. | **Escenario 1 – Resumen de sentimiento (200):**<br>**Given** solicitud GET a /api/v1/brands/{id}/sentiment con rango válido<br>**When** el servidor procesa<br>**Then** retorna 200 con porcentajes positivo/negativo/neutro y score general.<br><br>**Escenario 2 – Tendencia retornada (200):**<br>**Given** solicitud GET a /api/v1/brands/{id}/sentiment/trend con rango y agrupación<br>**When** el servidor procesa<br>**Then** retorna 200 con serie temporal de scores.<br><br>**Escenario 3 – Sin datos (404):**<br>**Given** rango sin menciones clasificadas<br>**When** el servidor consulta<br>**Then** retorna 404 con "No hay datos de sentimiento para el período indicado." | EP05 |
| **EP06** | **Gestión de Alertas** | Funcionalidad completa de panel de alertas, configuración de criterios y respuesta a menciones críticas, abarcando interfaz Angular y endpoints Spring Boot. | — | — |
| US22 | Recibir alertas de menciones críticas | Como PyME Owner o Agency Manager, quiero recibir alertas cuando se detecten menciones negativas críticas para poder actuar de forma inmediata. | **Escenario 1 – Panel de alertas:**<br>**Given** el sistema ha generado alertas para la marca<br>**When** el usuario accede al panel<br>**Then** muestra cada alerta con tipo, mención asociada, fecha y estado (Activa / Atendida).<br><br>**Escenario 2 – Indicador en navegación:**<br>**Given** hay alertas activas no revisadas<br>**When** el usuario navega por la aplicación<br>**Then** el ícono de alertas muestra un badge con el número de alertas pendientes.<br><br>**Escenario 3 – Sin alertas:**<br>**Given** no hay alertas activas<br>**When** el usuario accede al panel<br>**Then** muestra "Sin alertas críticas recientes." | EP06 |
| US23 | Configurar criterios de alerta | Como Agency Manager, quiero configurar los criterios bajo los cuales se generan alertas para personalizar el monitoreo según cada cliente. | **Escenario 1 – Guardado exitoso:**<br>**Given** el usuario modifica los criterios y guarda<br>**When** el sistema procesa<br>**Then** muestra "Criterios de alerta actualizados" y mantiene al usuario en la vista.<br><br>**Escenario 2 – Formulario precargado:**<br>**Given** el usuario accede a la configuración de alertas<br>**When** la vista carga<br>**Then** muestra los criterios actuales precargados.<br><br>**Escenario 3 – Sin criterios:**<br>**Given** el usuario borra todos los criterios e intenta guardar<br>**When** el sistema valida<br>**Then** muestra "Debes definir al menos un criterio para activar las alertas." | EP06 |
| US24 | Responder a una mención desde la alerta | Como PyME Owner o Agency Manager, quiero responder a una mención directamente desde el detalle de una alerta para gestionar rápidamente situaciones críticas. | **Escenario 1 – Respuesta enviada:**<br>**Given** el usuario redacta una respuesta y hace clic en "Enviar respuesta"<br>**When** el sistema procesa<br>**Then** actualiza el estado a "Respondida" y muestra la respuesta con fecha y hora.<br><br>**Escenario 2 – Campo vacío:**<br>**Given** el usuario intenta enviar con el campo vacío<br>**When** el sistema valida<br>**Then** muestra "El campo de respuesta no puede estar vacío."<br><br>**Escenario 3 – Vista de detalle:**<br>**Given** el usuario hace clic en una alerta del panel<br>**When** la vista carga<br>**Then** muestra el contenido de la mención, estado de la alerta y campo de texto para responder. | EP06 |
| TS11 | Endpoints de consulta y configuración de alertas | Como Developer, quiero implementar los endpoints de consulta y configuración de alertas en Spring Boot para gestionar las alertas de reputación. | **Escenario 1 – Alertas retornadas (200):**<br>**Given** solicitud GET a /api/v1/brands/{id}/alerts<br>**When** el servidor procesa<br>**Then** retorna 200 con listado de alertas (id, tipo, estado, mención, fecha).<br><br>**Escenario 2 – Criterios actualizados (200):**<br>**Given** solicitud PUT con criterios válidos a /api/v1/brands/{id}/alerts/config<br>**When** el servidor procesa<br>**Then** persiste y retorna 200.<br><br>**Escenario 3 – Sin alertas (200 vacío):**<br>**Given** la marca no tiene alertas<br>**When** el servidor consulta<br>**Then** retorna 200 con arreglo vacío. | EP06 |
| TS12 | Endpoint de respuesta a alerta | Como Developer, quiero implementar el endpoint de respuesta a alertas en Spring Boot para registrar la gestión de menciones críticas. | **Escenario 1 – Respuesta registrada (200):**<br>**Given** solicitud PATCH con respuesta válida a /api/v1/alerts/{id}/respond<br>**When** el servidor procesa<br>**Then** persiste con fecha y hora, actualiza estado a "Respondida" y retorna 200.<br><br>**Escenario 2 – No encontrada (404):**<br>**Given** id inexistente<br>**When** el servidor busca<br>**Then** retorna 404 con "Alerta no encontrada."<br><br>**Escenario 3 – Respuesta vacía (400):**<br>**Given** campo vacío en el body<br>**When** el servidor valida<br>**Then** retorna 400 con "El contenido de la respuesta es requerido." | EP06 |
| **EP07** | **Reportes y Dashboard** | Funcionalidad completa de dashboard de reputación, generación, historial, comparación y exportación de reportes, abarcando interfaz Angular y endpoints Spring Boot. | — | — |
| US25 | Ver dashboard de reputación | Como PyME Owner o Agency Manager, quiero ver un dashboard con las métricas principales de reputación para tener una visión general rápida del estado actual. | **Escenario 1 – Widgets con datos:**<br>**Given** la marca tiene menciones y análisis disponibles<br>**When** el usuario accede al dashboard<br>**Then** muestra widgets de volumen de menciones, distribución de sentimiento, alertas activas y tendencia reciente.<br><br>**Escenario 2 – Estado vacío:**<br>**Given** la marca no tiene menciones aún<br>**When** el usuario accede<br>**Then** muestra los widgets vacíos con "Comienza el monitoreo para ver los datos de reputación."<br><br>**Escenario 3 – Actualización:**<br>**Given** el usuario hace clic en "Actualizar"<br>**When** el sistema procesa<br>**Then** refresca los datos de los widgets sin recargar la página. | EP07 |
| US26 | Generar reporte de reputación | Como PyME Owner o Agency Manager, quiero generar un reporte de reputación de un período específico para documentar el desempeño de la marca. | **Escenario 1 – Generación exitosa:**<br>**Given** el usuario selecciona un rango de fechas con datos disponibles y solicita el reporte<br>**When** el sistema procesa<br>**Then** genera el reporte con sus métricas y habilita las opciones de descarga.<br><br>**Escenario 2 – Sin datos en el período:**<br>**Given** el rango seleccionado no tiene menciones<br>**When** el sistema procesa<br>**Then** muestra "No hay datos disponibles para el período seleccionado."<br><br>**Escenario 3 – Formulario con selector de fechas:**<br>**Given** el usuario accede a la vista de generación<br>**When** la vista carga<br>**Then** muestra el selector de rango de fechas y el botón "Generar reporte" habilitado. | EP07 |
| US27 | Ver historial de reportes | Como PyME Owner o Agency Manager, quiero ver el historial de reportes generados anteriormente para acceder a ellos sin tener que regenerarlos. | **Escenario 1 – Historial con reportes:**<br>**Given** el usuario ha generado reportes previamente<br>**When** accede al historial<br>**Then** muestra cada reporte con fecha de generación, período cubierto y botones de descarga y eliminación.<br><br>**Escenario 2 – Historial vacío:**<br>**Given** no hay reportes generados<br>**When** accede<br>**Then** muestra "Aún no has generado ningún reporte." con acceso directo al generador.<br><br>**Escenario 3 – Eliminación exitosa:**<br>**Given** el usuario confirma la eliminación de un reporte<br>**When** el sistema procesa<br>**Then** elimina el reporte del listado y muestra "Reporte eliminado." | EP07 |
| US28 | Exportar reporte | Como Agency Manager, quiero exportar el reporte de reputación en formato PDF o CSV para compartirlo con mis clientes o equipo interno. | **Escenario 1 – Exportación PDF:**<br>**Given** el usuario tiene un reporte generado<br>**When** hace clic en "Exportar PDF"<br>**Then** el sistema descarga el archivo automáticamente en el dispositivo.<br><br>**Escenario 2 – Exportación CSV:**<br>**Given** el usuario hace clic en "Exportar CSV"<br>**When** el sistema procesa<br>**Then** descarga el archivo CSV con los datos tabulados del reporte.<br><br>**Escenario 3 – Botones deshabilitados:**<br>**Given** el reporte aún se genera<br>**When** el usuario visualiza la vista<br>**Then** los botones de exportación aparecen deshabilitados con el aviso "El reporte aún está siendo generado." | EP07 |
| US29 | Comparar reputación entre períodos | Como Agency Manager, quiero comparar métricas de reputación entre dos períodos de tiempo para evaluar la evolución e impacto de las estrategias aplicadas. | **Escenario 1 – Comparación exitosa:**<br>**Given** el usuario selecciona dos períodos distintos con datos<br>**When** el sistema procesa<br>**Then** muestra un cuadro comparativo con variaciones en menciones, sentimiento y alertas entre ambos períodos.<br><br>**Escenario 2 – Períodos iguales:**<br>**Given** el usuario selecciona el mismo rango en ambos selectores<br>**When** intenta comparar<br>**Then** muestra "Los períodos seleccionados deben ser diferentes."<br><br>**Escenario 3 – Vista con selectores:**<br>**Given** el usuario accede a la comparación<br>**When** la vista carga<br>**Then** muestra dos selectores de rango independientes y el botón "Comparar" habilitado. | EP07 |
| TS13 | Endpoints de generación y consulta de reportes | Como Developer, quiero implementar los endpoints de generación y consulta del historial de reportes en Spring Boot para crear y listar reportes de reputación. | **Escenario 1 – Reporte generado (201):**<br>**Given** solicitud POST con rango válido a /api/v1/brands/{id}/reports<br>**When** el servidor procesa<br>**Then** genera, persiste y retorna 201 con id y enlace de descarga.<br><br>**Escenario 2 – Historial retornado (200):**<br>**Given** solicitud GET a /api/v1/brands/{id}/reports<br>**When** el servidor procesa<br>**Then** retorna 200 con listado de reportes.<br><br>**Escenario 3 – Sin datos (404):**<br>**Given** rango sin menciones<br>**When** el servidor procesa<br>**Then** retorna 404 con "No hay datos disponibles para el período indicado." | EP07 |
| TS14 | Endpoints de exportación y eliminación de reportes | Como Developer, quiero implementar los endpoints de exportación y eliminación de reportes en Spring Boot para completar la gestión del ciclo de vida de los reportes. | **Escenario 1 – Exportación exitosa (200):**<br>**Given** solicitud GET a /api/v1/reports/{id}/export?format={pdf\|csv}<br>**When** el servidor genera<br>**Then** retorna 200 con archivo en Content-Type correspondiente.<br><br>**Escenario 2 – Formato no soportado (400):**<br>**Given** formato distinto a pdf o csv<br>**When** el servidor valida<br>**Then** retorna 400 con "Formato no soportado. Usa pdf o csv."<br><br>**Escenario 3 – Eliminación exitosa (200):**<br>**Given** solicitud DELETE a /api/v1/reports/{id}<br>**When** el servidor procesa<br>**Then** elimina y retorna 200. | EP07 |
| TS15 | Endpoint de métricas consolidadas del dashboard | Como Developer, quiero implementar el endpoint de métricas del dashboard en Spring Boot para que el frontend consulte en una sola llamada los datos de los widgets principales. | **Escenario 1 – Métricas retornadas (200):**<br>**Given** solicitud GET a /api/v1/brands/{id}/dashboard<br>**When** el servidor procesa<br>**Then** retorna 200 con volumen de menciones, distribución de sentimiento, alertas activas y variación porcentual.<br><br>**Escenario 2 – Marca sin datos (200):**<br>**Given** la marca existe pero sin menciones<br>**When** el servidor consulta<br>**Then** retorna 200 con todos los campos numéricos en cero.<br><br>**Escenario 3 – No encontrada (404):**<br>**Given** id inexistente<br>**When** el servidor busca<br>**Then** retorna 404 con "Marca no encontrada." | EP07 |
...
| 2 | US02 | EP01 – Landing Page | Ver sección de funcionalidades | Como visitante de la landing page, quiero ver las funcionalidades principales de BrandRadar para evaluar si el producto cubre mis necesidades antes de registrarme. | 3 |
| 3 | US03 | EP01 – Landing Page | Ver testimonios en la landing page | Como visitante de la landing page, quiero ver testimonios de otros usuarios de BrandRadar para generar confianza antes de registrarme. | 2 |
| 4 | US04 | EP01 – Landing Page | Ver planes y precios en la landing page | Como visitante de la landing page, quiero ver los planes y precios disponibles de BrandRadar para decidir cuál se adapta mejor a mis necesidades. | 3 |
| 5 | US05 | EP01 – Landing Page | Enviar mensaje de contacto desde la landing page | Como visitante de la landing page, quiero enviar un mensaje de contacto a BrandRadar para resolver dudas antes de registrarme. | 3 |
| 6 | TS01 | EP02 – Gestión de Cuentas | Endpoint de registro de usuario | Como Developer, quiero implementar el endpoint de registro en Spring Boot para que la aplicación pueda crear nuevas cuentas de usuario. | 5 |
| 7 | US06 | EP02 – Gestión de Cuentas | Registrar cuenta | Como PyME Owner o Agency Manager, quiero crear una cuenta con mis datos básicos para acceder a las funcionalidades de monitoreo de reputación de BrandRadar. | 5 |
| 8 | TS02 | EP02 – Gestión de Cuentas | Endpoint de inicio de sesión y emisión de JWT | Como Developer, quiero implementar el endpoint de login en Spring Boot para autenticar usuarios y emitir tokens JWT. | 5 |
| 9 | US08 | EP02 – Gestión de Cuentas | Iniciar sesión | Como PyME Owner o Agency Manager con cuenta verificada, quiero iniciar sesión para acceder a mi panel de monitoreo de reputación en BrandRadar. | 3 |
| 10 | TS03 | EP02 – Gestión de Cuentas | Endpoint de verificación de correo | Como Developer, quiero implementar el endpoint de verificación de token en Spring Boot para activar las cuentas de usuario. | 3 |
| 11 | US07 | EP02 – Gestión de Cuentas | Verificar correo electrónico | Como usuario recién registrado, quiero verificar mi correo electrónico para activar mi cuenta y acceder a BrandRadar. | 3 |
| 12 | TS04 | EP02 – Gestión de Cuentas | Endpoint de recuperación de contraseña | Como Developer, quiero implementar el flujo de recuperación de contraseña en Spring Boot para que los usuarios puedan restablecer su acceso. | 5 |
| 13 | US09 | EP02 – Gestión de Cuentas | Recuperar contraseña | Como usuario registrado, quiero recuperar el acceso a mi cuenta mediante un correo de restablecimiento para poder ingresar si olvidé mi contraseña. | 3 |
| 14 | TS05 | EP02 – Gestión de Cuentas | Endpoint de refresh de token JWT | Como Developer, quiero implementar el endpoint de renovación de token en Spring Boot para mantener la sesión activa sin requerir un nuevo login. | 5 |
| 15 | US10 | EP02 – Gestión de Cuentas | Cerrar sesión | Como usuario autenticado, quiero cerrar sesión para proteger el acceso a mi cuenta desde dispositivos compartidos. | 2 |
| 16 | TS06 | EP03 – Configuración de Marca | Endpoints de creación y consulta de marcas | Como Developer, quiero implementar los endpoints de creación y consulta de marcas en Spring Boot para registrar y listar marcas del usuario autenticado. | 5 |
| 17 | US11 | EP03 – Configuración de Marca | Crear perfil de marca | Como PyME Owner o Agency Manager, quiero crear el perfil de mi marca con información básica y palabras clave para que BrandRadar comience a monitorizarla. | 5 |
| 18 | TS07 | EP03 – Configuración de Marca | Endpoints de edición y eliminación de marcas | Como Developer, quiero implementar los endpoints de edición y eliminación de marcas en Spring Boot para completar el CRUD de marcas. | 3 |
| 19 | US12 | EP03 – Configuración de Marca | Editar perfil de marca | Como PyME Owner o Agency Manager, quiero editar la información de una marca existente para mantener sus datos actualizados. | 3 |
| 20 | US13 | EP03 – Configuración de Marca | Eliminar marca | Como PyME Owner o Agency Manager, quiero eliminar una marca de mi panel para mantener solo las que están activas. | 2 |
| 21 | TS08 | EP03 – Configuración de Marca | Endpoints de palabras clave y fuentes de datos | Como Developer, quiero implementar los endpoints de palabras clave y fuentes de datos en Spring Boot para configurar el monitoreo de cada marca. | 8 |
| 22 | US14 | EP03 – Configuración de Marca | Configurar palabras clave de monitoreo | Como PyME Owner o Agency Manager, quiero configurar y editar las palabras clave de una marca para que el monitoreo capture las menciones relevantes. | 5 |
| 23 | US15 | EP03 – Configuración de Marca | Conectar fuentes de datos | Como PyME Owner o Agency Manager, quiero conectar plataformas digitales a una marca para que BrandRadar recolecte menciones de esas fuentes. | 8 |
| 24 | TS09 | EP04 – Monitoreo de Menciones | Endpoints de monitoreo y consulta paginada de menciones | Como Developer, quiero implementar los endpoints de inicio de monitoreo y consulta paginada de menciones en Spring Boot para habilitar la recolección y visualización de datos. | 8 |
| 25 | US16 | EP04 – Monitoreo de Menciones | Iniciar monitoreo de marca | Como PyME Owner o Agency Manager, quiero iniciar el monitoreo de una marca configurada para que BrandRadar recolecte menciones en tiempo real. | 5 |
| 26 | US17 | EP04 – Monitoreo de Menciones | Visualizar menciones recolectadas | Como PyME Owner o Agency Manager, quiero ver el listado de menciones recolectadas para estar al tanto de lo que se dice sobre mi marca en internet. | 5 |
| 27 | US18 | EP04 – Monitoreo de Menciones | Filtrar menciones por criterio | Como PyME Owner o Agency Manager, quiero filtrar menciones por fecha, fuente o sentimiento para encontrar rápidamente las más relevantes. | 5 |
| 28 | TS10 | EP05 – Análisis de Sentimiento | Endpoints de análisis de sentimiento y tendencias | Como Developer, quiero implementar los endpoints de análisis de sentimiento y tendencias en Spring Boot para consultar el estado reputacional de una marca. | 8 |
| 29 | US19 | EP05 – Análisis de Sentimiento | Ver análisis de sentimiento general | Como PyME Owner o Agency Manager, quiero ver el análisis de sentimiento general de mi marca para entender cómo está siendo percibida en internet. | 5 |
| 30 | US20 | EP05 – Análisis de Sentimiento | Ver menciones por categoría de sentimiento | Como PyME Owner o Agency Manager, quiero filtrar menciones según su categoría de sentimiento para priorizar las que requieren atención inmediata. | 3 |
| 31 | US21 | EP05 – Análisis de Sentimiento | Ver tendencia de sentimiento en el tiempo | Como Agency Manager, quiero ver la evolución del sentimiento de una marca a lo largo del tiempo para evaluar el impacto de las acciones tomadas. | 8 |
| 32 | TS11 | EP06 – Gestión de Alertas | Endpoints de consulta y configuración de alertas | Como Developer, quiero implementar los endpoints de consulta y configuración de alertas en Spring Boot para gestionar las alertas de reputación. | 5 |
| 33 | US22 | EP06 – Gestión de Alertas | Recibir alertas de menciones críticas | Como PyME Owner o Agency Manager, quiero recibir alertas cuando se detecten menciones negativas críticas para poder actuar de forma inmediata. | 5 |
| 34 | TS12 | EP06 – Gestión de Alertas | Endpoint de respuesta a alerta | Como Developer, quiero implementar el endpoint de respuesta a alertas en Spring Boot para registrar la gestión de menciones críticas. | 3 |
| 35 | US23 | EP06 – Gestión de Alertas | Configurar criterios de alerta | Como Agency Manager, quiero configurar los criterios bajo los cuales se generan alertas para personalizar el monitoreo según cada cliente. | 5 |
| 36 | US24 | EP06 – Gestión de Alertas | Responder a una mención desde la alerta | Como PyME Owner o Agency Manager, quiero responder a una mención directamente desde el detalle de una alerta para gestionar rápidamente situaciones críticas. | 3 |
| 37 | TS15 | EP07 – Reportes y Dashboard | Endpoint de métricas consolidadas del dashboard | Como Developer, quiero implementar el endpoint de métricas del dashboard en Spring Boot para que el frontend consulte en una sola llamada los datos de los widgets principales. | 8 |
| 38 | US25 | EP07 – Reportes y Dashboard | Ver dashboard de reputación | Como PyME Owner o Agency Manager, quiero ver un dashboard con las métricas principales de reputación para tener una visión general rápida del estado actual. | 8 |
| 39 | TS13 | EP07 – Reportes y Dashboard | Endpoints de generación y consulta de reportes | Como Developer, quiero implementar los endpoints de generación y consulta del historial de reportes en Spring Boot para crear y listar reportes de reputación. | 8 |
| 40 | US26 | EP07 – Reportes y Dashboard | Generar reporte de reputación | Como PyME Owner o Agency Manager, quiero generar un reporte de reputación de un período específico para documentar el desempeño de la marca. | 8 |
| 41 | US27 | EP07 – Reportes y Dashboard | Ver historial de reportes | Como PyME Owner o Agency Manager, quiero ver el historial de reportes generados anteriormente para acceder a ellos sin tener que regenerarlos. | 3 |
| 42 | TS14 | EP07 – Reportes y Dashboard | Endpoints de exportación y eliminación de reportes | Como Developer, quiero implementar los endpoints de exportación y eliminación de reportes en Spring Boot para completar la gestión del ciclo de vida de los reportes. | 5 |
| 43 | US28 | EP07 – Reportes y Dashboard | Exportar reporte | Como Agency Manager, quiero exportar el reporte de reputación en formato PDF o CSV para compartirlo con mis clientes o equipo interno. | 5 |
| 44 | US29 | EP07 – Reportes y Dashboard | Comparar reputación entre períodos | Como Agency Manager, quiero comparar métricas de reputación entre dos períodos de tiempo para evaluar la evolución e impacto de las estrategias aplicadas. | 8 |
...
| —            | —                                                | T00    | Base Landing Page Structure | Crear la estructura base de la landing page usando HTML puro. Incluir layout con `<header>`, `<nav>`, `<main>`, `<section>` y `<footer>`. Definir contenedores para todas las secciones y configurar `index.html` y `styles.css`. | 4 horas        | Brianna        | Done    |
| US01         | Ver propuesta de valor en la landing page        | T01    | Header & Hero UI            | Implementar sección de navegación y hero con propuesta de valor, descripción del producto y CTA principal visible sin scroll. Incluir diseño responsive para móvil y escritorio.                                                  | 6 horas                   | Brianna        | Done      |
| US02         | Ver sección de funcionalidades                   | T02    | Features Section            | Desarrollo de la sección de funcionalidades clave (monitoreo, alertas, reportes) con íconos, títulos y descripciones breves. Incluir navegación por scroll suave desde el menú.                                                   | 5 horas                   | Victor         | Done      |
| US03         | Ver testimonios en la landing page               | T03    | Testimonials Section        | Maquetación de la sección de testimonios con al menos dos tarjetas (PyME y agencia), controles de navegación entre testimonios y diseño adaptado a móvil.                                                                         | 4 horas                  | Jean           | Done      |
| US04         | Ver planes y precios en la landing page          | T04    | Pricing Section             | Implementar tabla de planes con características incluidas, precio mensual, plan recomendado destacado visualmente y CTA por plan que redirige al registro con plan preseleccionado.                                               | 6 horas                  | Luis           | Done      |
| US05         | Enviar mensaje de contacto desde la landing page | T05    | Contact Form & Footer       | Implementar formulario de contacto con validación de campos (nombre, correo, mensaje), mensaje de confirmación al envío exitoso y pie de página corporativo.                                                                      | 5 horas                 | Joaquin        | Done      |
